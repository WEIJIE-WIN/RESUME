...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser()#指定参数
    ...
    parser.add_argument("--num_heads", default=512, type=int,
    ...
    with open("data/" + args.data + "/ner2idx.json", "r",encoding='utf-8') as f:#加载字典
        ner2idx = json.load(f)
    with open("data/" + args.data + "/rel2idx.json", "r",encoding='utf-8') as f:
        rel2idx = json.load(f)

    train_batch, test_batch, dev_batch = dataloader.dataloader(args, ner2idx, rel2idx)
